...
const string strMessageMagic = "DubaiCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 105000 * COIN; //1% premine
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DubaiCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Februari 20, 2016: Bitcoin Price Passes $420 Mark Amid Institutional Attention";
        CTransaction txNew;
        txNew.nTime = 1455965293;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1455965293;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3833511;
        ...
        assert(block.hashMerkleRoot == uint256("0x184bdfd2a5a97b29b926a0913f0817fdb3aa6833bfacaab043321d9069b09048"));
